...
<Image src={images.param_handling} alt="param handling" width="800" height="400"/>
...
<Image src={images.virtual_memory} alt="param handling" width="800" height="400"/>
...
### 30. Keep working set small
Retrieving pages from outside the working set is slower because you are fetching from secondary storage. 
### Caching
...
Try to use more contiguous containers
```cpp
